...
int config_parse_exec(
        ...
        do {
                ...
                r = extract_first_word_and_warn(&p, &firstword, WHITESPACE, UNQUOTE_CUNESCAPE, unit, filename, line, rvalue);
                if (r <= 0)
                        return 0;
                ...
                for (;;) {
                        ...
                        r = extract_first_word_and_warn(&p, &word, WHITESPACE, UNQUOTE_CUNESCAPE, unit, filename, line, rvalue);
                        if (r == 0)
                                break;
                        else if (r < 0)
                                return 0;
